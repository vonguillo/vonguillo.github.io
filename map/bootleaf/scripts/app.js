var map, featureList, boroughSearch = [], theaterSearch = [], museumSearch = [], mobileDevice = true;
...
function syncSidebar() {
  ...
  theaters.eachLayer(function (layer) {
    if (map.hasLayer(theaterLayer)) {
      if (map.getBounds().contains(layer.getLatLng())) {
        $("#feature-list tbody").append('<tr class="feature-row" id="' + L.stamp(layer) + '" lat="' + layer.getLatLng().lat + '" lng="' + layer.getLatLng().lng + '"><td style="vertical-align: middle;"><img width="16" height="18" src="/360/map/assets/img/theater.png"></td><td class="feature-name">' + layer.feature.properties.NAME + '</td><td style="vertical-align: middle;"><i class="fa fa-chevron-right pull-right"></i></td></tr>');
      }
    }
  });
  ...
  //    if (map.getBounds().contains(layer.getLatLng())) {
  //      $("#feature-list tbody").append('<tr class="feature-row" id="' + L.stamp(layer) + '" lat="' + layer.getLatLng().lat + '" lng="' + layer.getLatLng().lng + '"><td style="vertical-align: middle;"><img width="16" height="18" src="/360/map/assets/img/museum.png"></td><td class="feature-name">' + layer.feature.properties.NAME + '</td><td style="vertical-align: middle;"><i class="fa fa-chevron-right pull-right"></i></td></tr>');
  //    }
  //  }
  //});
...
var theaters = L.geoJson(null, {
  pointToLayer: function (feature, latlng) {
    return L.marker(latlng, {
      icon: L.icon({
        iconUrl: "/360/map/assets/img/theater.png",
        iconSize: [24, 28],
        iconAnchor: [12, 28],
        popupAnchor: [0, -25]
      }),
        ...
        click: function (e) {
            if (mobileDevice) {
                ...
                if (e.latlng == null) {
                    ...
                    var eventCoords = [feature.geometry.coordinates[1], feature.geometry.coordinates[0]];
                } else {
                    var eventCoords = e.latlng;

                }

                var popup = L.popup()
                .setLatLng(eventCoords)
                .setContent(feature.properties.NAME + "<br/>" + feature.properties.TEL)
                .openOn(map);
            }
        }
      });
...
$.getJSON("/api/Nsar/GetNsarMapData", function (data) {
    theaters.addData(data.Records);
    map.addLayer(theaterLayer);
});
...
//    return L.marker(latlng, {
//      icon: L.icon({
//        iconUrl: "/360/map/assets/img/museum.png",
//        iconSize: [24, 28],
//        iconAnchor: [12, 28],
//        popupAnchor: [0, -25]
//      }),
...
attributionControl.onAdd = function (map) {
  ...
  div.innerHTML = "<span class='hidden-xs'>BootLeaf by <a href='http://bryanmcbride.com'>bryanmcbride.com</a> | </span><a href='#' onclick='$(\"#attributionModal\").modal(\"show\"); return false;'>Attribution</a>";
  return div;
};
...
var groupedOverlays = {
  "Points of Interest": {
    "<img src='/360/map/assets/img/theater.png' width='24' height='28'>&nbsp;Theaters": theaterLayer
    //"<img src='/360/map/assets/img/museum.png' width='24' height='28'>&nbsp;Museums": museumLayer
  }
};
...
$(document).one("ajaxStop", function () {
  ...
  mq800.addListener(handleOrientationChange);
  handleOrientationChange(mq800);
...
//  //  templates: {
//  //    header: "<h4 class='typeahead-header'><img src='/360/map/assets/img/theater.png' width='24' height='28'>&nbsp;Theaters</h4>",
...
//    templates: {
//      header: "<h4 class='typeahead-header'><img src='/360/map/assets/img/museum.png' width='24' height='28'>&nbsp;Museums</h4>",
//      suggestion: Handlebars.compile(["{{name}}<br>&nbsp;<small>{{address}}</small>"].join(""))
//    }
//  }, {
//    name: "GeoNames",
...
//    templates: {
//      header: "<h4 class='typeahead-header'><img src='/360/map/assets/img/globe.png' width='25' height='25'>&nbsp;GeoNames</h4>"
//    }
